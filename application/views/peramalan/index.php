                  ...
                  <tbody>
                    ...
                    <?php
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="<?php echo base_url('peramalan/detail/'. $isi['id_peramalan']) ?>" class="btn btn-light-primary">Lihat Detail</a>
                          <a href="<?php echo base_url('peramalan/delete/'. $isi['id_peramalan']) ?>" class="btn btn-light-danger">Hapus</a>
                        </td>
                      </tr>
                      <?php endforeach ?>
