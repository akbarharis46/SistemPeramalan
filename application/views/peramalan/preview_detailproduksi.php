              ...
              <div class="row">
                  <div class="col-md-12">
                    ...
                    <?php } else if ( $jenis == "keseluruhan" ) { ?>
                            ...
                            <?php echo number_format ($summary_mape[ $hasilIndex ], 2)."%"  ?> dengan hasil peramalan <?php echo $summary_perhitungan[ $hasilIndex ] ?>.
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
                        <div class="modal-content">
                            ...
                            <!-- <div class="modal-body">
                                ...
                                <p>Dengan melihat data peramalan ini, anda diwajibkan untuk memverifi******kasi hasil peramalan untuk sebagai acuan produksi air minum</p>
