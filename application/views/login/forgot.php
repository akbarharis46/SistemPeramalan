		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="login login-4 wizard d-flex flex-column flex-lg-row flex-column-fluid">
						...
						<div class="login-form">
							<!--begin::Form-->
								...
								<div class="pb-5 pb-lg-15">
									<h1 class="font-weight-bolder text-dark font-size-h2 font-size-h1-lg">Reset Password</h1>
                ...
                <div class="form-group">
									...
									<input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg border-0" type="text" id="username" placeholder="Masukkan username" name="username"autocomplete="off" />
								</div>
                <div class="form-group">
									<label class="font-size-h6 font-weight-bolder text-dark">Kode Unik</label>
									<input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg border-0" type="text" id="kode_unik" placeholder="Masukkan username" name="kode_unik"autocomplete="off" />
								</div>
