...
<form action="<?php echo base_url('login/verify') ?>" method="POST">
    ...
    <marquee behavior="" direction="">Masukkan username dan kode unik pendaftaran anda</marquee>

    <input type="text" name="username" placeholder="Masukkan username anda . . ."  required=""/> <br>
    <input type="text" name="kode_unik" placeholder="Masukkan kode unik pendaftaran . . ." required="" />

    <br>

    <button>Prosess</button>
		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="login login-4 wizard d-flex flex-column flex-lg-row flex-column-fluid">
						...
						<div class="login-form">
							<!--begin::Form-->
								...
								<div class="pb-5 pb-lg-15">
									<h1 class="font-weight-bolder text-dark font-size-h2 font-size-h1-lg">Atur Ulang Kata Sandi</h1>
								...
								<!--begin::Title-->
								<!--begin::Form group-->
                <form action="<?php echo base_url('login/processUpdateAccount/'. $id) ?>" method="POST">
                ...
                <div class="form-group">
									...
									<input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg border-0" type="text" id="new_pw" placeholder="Masukkan Password Baru" name="new_pw"autocomplete="off" />
								</div>
                <div class="form-group">
									<label class="font-size-h6 font-weight-bolder text-dark">Confrim Password</label>
									<input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg border-0" type="text" id="confirm_pw" placeholder="Masukkan Kembali Password Baru " name="confirm_pw"autocomplete="off" />
								</div>
								...
								<div class="pb-lg-0 pb-5">
									<button type="submit" id="kt_login_singin_form_submit_button" class="btn btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-3">Proses Reset</button>
