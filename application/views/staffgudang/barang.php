                    ...
                    <form action="" method="GET">
                      <div class="row">
                        ...
                        <div class="col-md-3">
                          ...
                          <a href="<?php echo base_url('BarangClient/indexgudang') ?>" class="btn btn-outline-secondary">
                        ...
                        <div class="col-md-12">
                          ...
                          ?>
                          <a class='btn btn-danger' href="<?php echo site_url('Barangclient/exportToPDF?interval-tanggal=' . $filter_data_tanggal); ?>">
                            <i class="fa fa-file-pdf"></i>
                            <span>
                              Filter PDF
                            </span>
                          </a>
                          <a class="btn btn-success" href="<?php echo site_url('Barangclient/exportToExcel?interval-tanggal=' . $filter_data_tanggal); ?>">
                    ...
                    <tbody>
                      ...
                      foreach ($barang as $rows) : ?>
                        <tr>
                          ...
                          <td>
                            <a href="<?php echo site_url(); ?>BarangClient/putbarang/<?php echo $rows->id_detailsuplaimasuk; ?>" class="btn btn-warning">
                              <i class="fa fa-pen" aria-hidden="true"></i></a>
                            <a href="<?= base_url(); ?>BarangClient/deletebarang/<?= $rows->id_detailsuplaimasuk; ?>" class="btn btn-danger" onClick="return confirm('yakin mau hapus');">
