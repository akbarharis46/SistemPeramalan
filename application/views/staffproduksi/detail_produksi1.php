                  ...
                  <tbody>
                    ...
                    foreach ($detailproduksi as $rows) : ?>
                      <tr>
                        ...
                        <td>
                          <a href="<?php echo site_url(); ?>DetailStockProduksiClient/putproduksi/<?php echo $rows->id_transaksiproduksi; ?>" class="btn btn-warning">
                            <i class="fa fa-pen" aria-hidden="true"></i></a>

                          <a href="<?php echo site_url(); ?>PenguranganStockProduksiClient/indexproduksi/<?php echo $rows->id_transaksiproduksi; ?>" class="btn btn-primary">
                            <i class="fa fa-eye" aria-hidden="true"></i></a>


                          <a href="<?= base_url(); ?>DetailProduksiClient/deleteproduksi/<?= $rows->id_transaksiproduksi; ?>" class="btn btn-danger" onClick="return confirm('Apakah Yakin Untuk Menghapus Data?');">
