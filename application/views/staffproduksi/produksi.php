                    ...
                    <form action="" method="GET">
                      <div class="row">
                        ...
                        <div class="col-md-2">
                          ...
                          <a href="<?php echo base_url('ProduksiClient/indexproduksi') ?>" class="btn btn-outline-secondary">
                    ...
                    <tbody>
                      ...
                      foreach ($produksi as $rows) : ?>
                        <tr>
                          ...
                          <td>
                            <a href="<?php echo site_url(); ?>ProduksiClient/putproduksi/<?php echo $rows->id_hasilproduksi; ?>" class="btn btn-warning">
                              <i class="fa fa-pen" aria-hidden="true"></i></a>


                            <a class="btn btn-success " href="<?= base_url(); ?>ProduksiClient/data_staffproduksikeluar/<?php echo $rows->id_hasilproduksi ?>">
                              <i class="fas fa-arrow-right" aria-hidden="true"></i></a>


                            <a href="<?php echo site_url(); ?>ProduksiClient/deleteproduksi/<?php echo $rows->id_hasilproduksi ?>" class="btn btn-danger" onClick="return confirm('yakin mau hapus');">
