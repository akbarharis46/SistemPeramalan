    ...
    <div class="content-wrapper">
        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <form action="<?php echo site_url(); ?>DetailHasilProduksiBulananClient/put_process" class="needs-validation" method="POST" enctype="multipart/form-data" onload="setSelectBoxByText()">
