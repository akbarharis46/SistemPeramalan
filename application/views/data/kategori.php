                  ...
                  <tbody>
                    ...
                    foreach ($kategori as $rows) : ?>
                      <tr>
                        ...
                        <td>
                          <a href="<?php echo site_url(); ?>KategoriClient/put/<?php echo $rows->id_bahanbaku; ?>" class="btn btn-warning">
                            <i class="fa fa-pen" aria-hidden="true"></i></a>
                          <a href="<?= base_url(); ?>KategoriClient/delete/<?= $rows->id_bahanbaku; ?>" class="btn btn-danger" onClick="return confirm('yakin mau hapus');">
