            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class='card-header' style="margin-left:-20px;">
                  ...
                  <a class='btn btn-danger' href="<?php echo site_url(); ?>DetailStockProduksiClient/date/">
                    <i class="fa fa"></i>
                    <span>
                      Sesuaikan Tanggal
                    </span>
                  ...
                  <tbody>
                    ...
                    foreach ($detailstockproduksi as $rows) : ?>
                      <tr>
                        ...
                        <td>
                          <a href="<?php echo site_url(); ?>DetailStockProduksiClient/put/<?php echo $rows->id_detailhasilproduksi; ?>" class="btn btn-warning">
                            <i class="fa fa-pen" aria-hidden="true"></i></a>
                          <a href="<?= base_url(); ?>DetailStockProduksiClient/delete/<?= $rows->id_detailhasilproduksi; ?>" class="btn btn-danger" onClick="return confirm('yakin mau hapus');">
