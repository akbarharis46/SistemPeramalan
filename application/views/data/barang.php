                    ...
                    <form action="" method="GET">
                      <div class="row">
                        ...
                        <div class="col-md-3">
                          ...
                          <a href="<?php echo base_url('BarangClient') ?>" class="btn btn-outline-secondary">
                    ...
                    <tbody>
                      ...
                      foreach ($barang as $rows) : ?>
                        <tr>
                          ...
                          <td>
                            <a href="<?php echo site_url(); ?>BarangClient/put/<?php echo $rows->id_detailsuplaimasuk; ?>" class="btn btn-warning">
                              <i class="fa fa-pen" aria-hidden="true"></i></a>
                            <a href="<?= base_url(); ?>BarangClient/delete/<?= $rows->id_detailsuplaimasuk; ?>" class="btn btn-danger" onClick="return confirm('yakin mau hapus');">
